...
public class OutputMessages {
    ...
    public static final String illegalMachineName = "Machine name cannot be null or empty.";

    public static final String illegalPilot = "Pilot cannot be null.";

    public static final String attackName = "Attack target cannot be null or empty string.";

    public static final String illegalPilotName = "Pilot name cannot be null or empty string.";
}
